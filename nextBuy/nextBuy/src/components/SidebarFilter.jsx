...
//       <br /><br />
//   <div className="mb-6 group w-fit" style={{paddingLeft:"50px"}}>
...
//  <div className="mainBox w-70 " style={{marginLeft:"50px"}}>
...
//       <br />
//       <input type="text" name="price" className="mr-2 h-12 w-25 border border-gray-300 rounded-md text-center" placeholder='₹      0'/>
      

//     <font style={{paddingLeft:"30px"}}>to</font>
//       {/* <input type="radio" name="price" className="mr-2" /> */}
//       <input type="text" name="price" style={{marginLeft:"30px"}} className="mr-2 h-12 w-25 border border-gray-300 rounded-md text-center" placeholder='₹    22500'/>

      
//   </SidebarFilter>
//   </div>

//   {/* Add more <SidebarFilter /> for Color, Brand, etc. */}
// </div>
...
//   style={{width:"300px",paddingLeft:"20px",height:"35px"}}
// />


// <select onChange={(e) => setSortTerm(e.target.value)} className=" px-4 py-2 mx-2 rounded" style={{border:"none" , marginLeft:"100px",width:"200px"}}>
